...
class OrderDTOtoOrderEntityMapperImplTest {
    ...
    void mapUserIdToUserEntity() {
        ...
        assertThat(orderDTOtoOrderEntityMapper.mapUserIdToUserEntity(1L)).isNotNull();
    }

    @Test
    void mapOrderDTOtoOrderEntity() {
        assertThat(orderDTOtoOrderEntityMapper.mapOrderDTOtoOrderEntity(null)).isNotNull();
    }
}